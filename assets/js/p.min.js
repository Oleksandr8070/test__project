...
jQuery(document).ready(function () {
    ...
    let userInformation = [];
    $(".bq1").click(function () {
        userInformation.push($(this).text().trim())
        ...
        scrollTo("id1"), $("#content1").fadeOut("slow", function () {
            $("#content2").fadeIn(), setTimeout(function () {
                ...
                $("#content2").fadeOut("slow", function () {
                    "undefined" != typeof roulette_ini ? rouletteRoot._init() : "undefined" != typeof box_ini && boxRoot._init(userInformation), $("#content3").fadeIn()
                })
            }, 7100)
        })
    })
...
! function () {
    "use strict";   
    boxRoot = {
        _init: function (userInformation) {
            setTimeout(function () {
                ...
                e.preventDefault(), jQuery("#p_modal3").modal("hide")
